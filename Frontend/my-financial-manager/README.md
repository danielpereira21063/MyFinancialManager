...
![GitHub repo size](https://img.shields.io/github/repo-size/AndrewJBateman/my-financial-manager?style=plastic)
![GitHub pull requests](https://img.shields.io/github/issues-pr/AndrewJBateman/my-financial-manager?style=plastic)
![GitHub Repo stars](https://img.shields.io/github/stars/AndrewJBateman/my-financial-manager?style=plastic)
![GitHub last commit](https://img.shields.io/github/last-commit/AndrewJBateman/my-financial-manager?style=plastic)

## :page_facing_up: Table of contents

* [:zap: Angular Material Nav](#zap-my-financial-manager)
...
* Run `ng build --prod --baseHref="https://github.com/AndrewJBateman/my-financial-manager/"` then commit to Github as usual
